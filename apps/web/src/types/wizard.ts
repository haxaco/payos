  ...
  'api-monetization': {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Add initial funds via card, Apple Pay, Google Pay, or bank transfer',
        shortLabel: 'Fund wallet',
        isRequired: false,
        estimatedMinutes: 3,
        helpText: 'Add USDC to your wallet so you can test payments. You can also fund later from Settings.',
        skipWarning: 'Your wallet will start with a zero balance. You can fund it anytime from the dashboard.',
      },
      {
  ...
  'agent-commerce': {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Your agent needs funds to make purchases',
        shortLabel: 'Fund wallet',
        isRequired: false,
        estimatedMinutes: 3,
        helpText: 'Agents draw from this wallet to make purchases. Add initial funds now or fund later.',
        skipWarning: 'Your agent will not be able to make purchases without wallet funds.',
      },
      {
        id: 'configure-limits',
  ...
  'recurring-payments': {
    ...
    steps: [
      ...
      },
      {
        id: 'fund-wallet',
        title: 'Fund Your Wallet',
        description: 'Add funds for recurring payment operations',
        shortLabel: 'Fund wallet',
        isRequired: false,
        estimatedMinutes: 3,
        helpText: 'Your wallet needs funds for mandate executions. Fund now or add funds later.',
        skipWarning: 'Mandates will fail if wallet has insufficient balance.',
      },
      {
        id: 'register-agent',
