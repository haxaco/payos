...
export default function TemplatesSettingsPage() {
  // WIP: mock-only, no backend. Gated until the templates API ships.
  // See docs/prd/epics/stories/wip/web-templates-wip.md
  if (!isWebFeatureEnabled('templates')) {
    return (
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-300 dark:border-gray-700 py-20 text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm">
          Reusable payment & stream templates aren&apos;t available yet. This
