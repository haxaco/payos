...
| Python / Go / Rust / other backend | Raw REST with the [API reference](/api-reference/openapi) |
...
All four packages are open source and live in the Sly monorepo. Issues and PRs welcome — see the [GitHub repo](https://github.com/sly-ai/platform).
