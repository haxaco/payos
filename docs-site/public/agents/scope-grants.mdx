...
<CardGroup cols={3}>
  ...
  <Card title="treasury" icon="vault">
    Move funds — settlement on `x402/pay`, `acp/checkouts/:id/complete`, `ap2/mandates/:id/execute`, `ucp/checkouts/:id/complete`, and sibling `send-usdc`. **One_shot only** (DB-enforced).
  </Card>
</CardGroup>
