...
|----------|-------|--------|
| `SUPABASE_URL` | `https://lgsreshwntpdrthfgwos.supabase.co` | Required ✅ |
| `SUPABASE_SERVICE_ROLE_KEY` | `sb_secret_ley...` | Required ✅ |
| `SUPABASE_ANON_KEY` | `sb_publishable_9mD...` | Required ✅ |
...
```bash
curl -I https://lgsreshwntpdrthfgwos.supabase.co
...
| **Supabase** | ✅ Running | https://lgsreshwntpdrthfgwos.supabase.co |
